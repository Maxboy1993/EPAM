...
public class Booklet extends Paper {
    ...
    public Booklet(long id, String title, String periodical, boolean isColour, int volume, boolean subscription, Date publishingDate) {
    ...
    public boolean equals(Object o) {
        ...
        return id == booklet.id &&
                isColour == booklet.isColour &&
                volume == booklet.volume &&
                subscription == booklet.subscription &&
                Objects.equals(title, booklet.title) &&
                Objects.equals(periodical, booklet.periodical) &&
                Objects.equals(publishingDate, booklet.publishingDate);
    }
