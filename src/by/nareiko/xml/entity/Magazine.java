...
public class Magazine extends Paper {
    ...
    public Magazine(long id, String title, String periodical, boolean isColour, int volume, boolean subscription, Date publishingDate) {
    ...
    public boolean equals(Object o) {
        ...
        return id == magazine.id &&
                isColour == magazine.isColour &&
                volume == magazine.volume &&
                subscription == magazine.subscription &&
                Objects.equals(title, magazine.title) &&
                Objects.equals(periodical, magazine.periodical) &&
                Objects.equals(publishingDate, magazine.publishingDate);
    }
